...
const PAYMENT_TYPES = [
  { value: 'alipay', label: 'Alipay (Epay)' },
  { value: 'wxpay', label: 'WeChat Pay (Epay)' },
  { value: 'alipayv3', label: 'Alipay v3 (Direct Connect)' },
  { value: 'wechat_native', label: 'WeChat Native Pay (Direct Connect)' },
